    ...
    def generate_text_semantic(
        ...
        **kwargs,
        ...
        semantic_output = self.generate(
            ...
            assistant_model=semantic_assistant,
        ...
        **kwargs,
        ...
        for _ in range(n_window_steps):
            ...
            output_coarse = self.generate(
                ...
                assistant_model=coarse_assistant,
                **kwargs,
            )
    ...
    def generate_speech(
        ...
        **kwargs,
        ...
        semantic_output = self.semantic.generate_text_semantic(
            ...
            semantic_assistant=semantic_assistant,
            **kwargs,
        )
        ...
        coarse_output = self.coarse_acoustics.generate_coarse(
            ...
            coarse_assistant=coarse_assistant,
            **kwargs,
        )
